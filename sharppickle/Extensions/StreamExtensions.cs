...
internal static class StreamExtensions {
    ...
    /// <summary>
    /// Reads the specified number of bytes from the current <see cref="Stream"/> and returns the result as an instance of <see cref="ReadOnlyMemory{T}"/>.
    /// </summary>
    ...
    /// <summary>
    /// Reads the specified number of bytes from the current <see cref="Stream"/> and returns the result as an instance of <see cref="ReadOnlySpan{T}"/>.
    /// </summary>
    /// <param name="stream">The <see cref="Stream"/> to read the data from.</param>
    /// <param name="length">The length of the data to read.</param>
