...
internal static class StackExtensions {
    ...
    /// <summary>
    /// Removes the top-most element from the <see cref="Stack"/> and casts it to the specified type <typeparamref name="T"/>.
    /// </summary>
    /// <typeparam name="T">The expected type of the object.</typeparam>
    /// <param name="stack">The stack to pop the first element from.</param>
    /// <returns>The top object of the <paramref name="stack" /> as the specified type.</returns>
    /// <exception cref="UnpicklingException">The element is of type {type} but {T} was expected.</exception>
